...
import pl.pwsztar.edu.domain.entity.Token;
import pl.pwsztar.edu.domain.mapper.converter.Convert;
import pl.pwsztar.edu.domain.repository.ClientRepository;
import pl.pwsztar.edu.domain.repository.TokenRepository;
import pl.pwsztar.edu.service.AccessService;
import pl.pwsztar.edu.domain.token.JwtTokenUtil;
...
public class AccessServiceImpl implements AccessService {
    ...
    public AccessServiceImpl(ClientRepository clientRepository,
                             ...
                             Convert<ClientDto,Client> clientDtoMapper ,
                             Convert<Client,ClientDto> clientMapper,
        ...
        if(checkEmail.isPresent()){
            try {
                ...
                if(toHexString(getSHA(password)).equals(client.getPassword())){
                    ...
                    tokenRepository.save(new Token(client.getUserId(),token));
